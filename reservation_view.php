...
$sql = "SELECT kniha.Nazev,users.first_name,users.last_name,reservation.start,reservation.end,users.username
FROM `reservation`
INNER JOIN kniha ON reservation.id_book=kniha.ID
INNER JOIN users ON users.id=reservation.id_user";
